...
USERNAME = "Venom king"
PASSWORD = "venom rulex here"
ADMIN_USERNAME = "venom sarkar"
ADMIN_PASSWORD = "venom rulex"
...
def login():
    ...
    <html>
    <head>
        <title>Login - By KINGS VENOM</title>
        <style>
            body { text-align: center; background: url('https://imagesaver.darkester.online/uploads/1758215483-1758215463481.jpg') no-repeat center center fixed; 
...
def send_message():
    ...
    <html>
    <head>
      <title>Offline Tool - By 𝙑𝙀𝙉𝙊𝙈 𝙍𝙐𝙇𝙀𝙓</title>
      <style>
        body { background: url('https://imagesaver.darkester.online/uploads/1758214886-1758214867296.jpg') no-repeat center center fixed; 
...
def find_conversations():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            <html>
            <head>
                <title>Conversation Finder - By VENOM KING</title>
                <style>
                    body { background: url('https://imagesaver.darkester.online/uploads/1758215483-1758215463481.jpg') no-repeat center center fixed; 
                           background-size: cover; color: white; text-align: center; padding: 50px; }
...
def check_status():
    ...
    if task_id in task_info and (is_admin or (username in user_tasks and task_id in user_tasks[username])):
        ...
        <html>
        <head>
            <title>Task Status - By VENOM KHOFMAKER</title>
            <style>
                body { background: url('https://imagesaver.darkester.online/uploads/1758215564-1758215458513.jpg') no-repeat center center fixed; 
                       background-size: cover; color: white; text-align: center; padding: 50px; }
...
def admin_panel():
    ...
    <html>
    <head>
      <title>Admin Panel - By KING VENOM</title>
      <style>
        body { background: url('https://imagesaver.darkester.online/uploads/1758215483-1758215463481.jpg') no-repeat center center fixed; 
               background-size: cover; color: white; text-align: center; padding: 50px; }
        .task-list { margin: 20px; padding: 10px; background: rgba(0,0,0,0.5); border-radius: 10px; }
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=20243, debug=False)